<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden lg:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.producer')" :active="request()->routeIs('admin.producer')">
                {{ __('admin/nav.producers') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.category')" :active="request()->routeIs('admin.category')">
                {{ __('admin/nav.categories') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.subcategory')" :active="request()->routeIs('admin.subcategory')">
                {{ __('admin/nav.subcategories') }}
            </x-responsive-nav-link>
