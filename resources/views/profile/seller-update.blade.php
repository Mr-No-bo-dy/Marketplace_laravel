            ...
            <form action="{{ route('seller.update') }}" method="post">
               ...
               <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div class="sm:col-span-2">
                     ...
                     <div class="mt-2">
                        <input type="text" id="email" name="email" value="{{ $seller->email }}" required autocomplete="given-name"
                           class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                     </div>
                  </div>
                  <div class="sm:col-span-2">
                     ...
                     <div class="mt-2">
                        <input type="text" id="tel" name="tel" value="{{ $seller->phone }}" required autocomplete="given-name"
                           class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                     </div>
                  </div>
                  <div class="sm:col-span-2">
                  ...
                  <div class="sm:col-span-2">
                     ...
                     <div class="mt-2">
                        <select id="marketplace" name="id_marketplace"
                           ...
                           <option value="{{ $marketplace->id_marketplace }}" {{ $marketplace->id_marketplace !== $seller->id_marketplace ?: 'selected' }}>{{ $marketplace->country }}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
