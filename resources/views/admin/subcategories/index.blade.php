      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
         <div class="p-6 text-gray-900">
            ...
            <ul role="list">
               ...
               <li class="group/item grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8 py-4 sm:px-4 lg:px-8 hover:bg-slate-100 @if(!is_null($subcategory->deleted_at)) bg-red-100 @endif ...">
                  ...
                  <div class="sm:col-span-1 justify-self-end self-center">
                   ...
                   @else
                       <form class="sm:col-span-1 justify-self-end self-center" action="{{ route('admin.subcategory.restore') }}" method="post">
                           @csrf
