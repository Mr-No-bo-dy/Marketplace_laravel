                ...
                <form action="{{ route('seller.update') }}" method="POST">
                    ...
                    <div class="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" id="surname" name="surname" value="{{ old('surname', $seller->surname) }}"
                                    autocomplete="given-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('surname')
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" id="email" name="email" value="{{ old('email', $seller->email) }}" required
                                    autocomplete="given-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('email')
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <input type="text" id="tel" name="phone" value="{{ old('phone', $seller->phone) }}" required
                                    autocomplete="given-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('phone')
                        ...
                        <div class="sm:col-span-2">
                            <label for="marketplace"
                                   class="block text-sm font-medium leading-6 text-gray-900">{{ __('site_profile.marketplace') }}</label>
                            <div class="mt-2">
                                <select id="marketplace" name="id_marketplace"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    @foreach ($marketplaces as $marketplace)
                                        <option value="{{ $marketplace->id_marketplace }}"
                                            {{ $marketplace->id_marketplace !== $seller->id_marketplace ?: 'selected' }}>{{ $marketplace->country }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
