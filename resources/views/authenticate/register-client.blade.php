...
<div class="flex min-h-full flex-col justify-center p-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h1 class="mt-4 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">{{ __('site_profile.signUp') }}</h1>
    </div>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="{{ route('registration_client') }}" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="tel" type="text" name="tel" autocomplete="given-name" required
                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                    <input id="surname" type="text" name="surname" autocomplete="given-name"
                       class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
            </div>
        ...
        <p class="mt-6 text-center text-sm text-gray-500">
            {{ __('site_profile.beSeller') }}
            <a href="{{ route('registration_seller') }}" class="ms-2 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                {{ __('site_profile.signUpSeller') }}</a>
        </p>
