                ...
                <form action="{{ route('product.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-2">
                                <input type="number" step="0.01" name="price" value="{{ old('price', $product->price) }}" id="price"
                                    autocomplete="given-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('price')
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-2">
                                <input type="number" name="amount" value="{{ old('amount', $product->amount) }}" id="amount"
                                    autocomplete="given-name"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('amount')
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2">
                                <select name="id_producer" id="producer"
                                    ...
                                    <option value="{{ $producer->id_producer }}"
                                        {{ $producer->id_producer !== $product->id_producer ?: 'selected' }}>
                            ...
                            <div class="mt-2">
                                <select name="id_category" id="category"
                                    ...
                                    <option value="{{ $category->id_category }}"
                                        {{ $category->id_category !== $product->id_category ?: 'selected' }}>
                            ...
                            <div class="mt-2">
                                <select name="id_subcategory" id="subcategory"
                                    ...
                                    <option value="{{ $subcategory->id_subcategory }}"
                                        {{ $subcategory->id_subcategory !== $product->id_subcategory ?: 'selected' }}>
                        ...
                        <div class="col-span-2 sm:col-span-8">
                            ...
                            <div class="mt-2">
                                ...
                                <label for="delImgs"
                                    class="inline-block text-sm font-medium leading-6 text-gray-900">{{ __('products.deleteOldMedia') }}</label>
                            </div>
                        </div>
                    </div>
