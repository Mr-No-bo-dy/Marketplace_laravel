                  ...
                  <div class="sm:col-span-2">
                     ...
                     <div class="mt-2">
                        <select name="id_subcategory" id="subcategory"
                           ...
                           <option value="{{ $subcategory->id_subcategory }}">{{ ucfirst($subcategory->name) }}</option>
                           @endforeach
                        </select>
                     </div>
                  </div>
                  <div class="sm:col-span-2">
                     <label for="image" class="block text-sm font-medium leading-6 text-gray-900">{{ __('products.image') }}</label>
                     <div class="mt-2">
